...
class SummerJobFinder implements ActionListener
  {  
   JLabel displayLabel;
   JButton nextButton;
   JButton prevButton;
   ...
   ResourceBundle summerJobFinder;
   ...
   SummerJobFinder()
     {  
      try
        {
         summerJobFinder = ResourceBundle.getBundle("resources.SummerJobFinderResources",Locale.getDefault());
        }
      ...
      JFrame jfrm = new JFrame(summerJobFinder.getString("SummerJobFinderTitle"));  
      ...
      prevButton = new JButton(summerJobFinder.getString("Prev"));
      prevButton.setActionCommand("Prev");
      buttonPanel.add(prevButton);
      prevButton.addActionListener(this);
      
      nextButton = new JButton(summerJobFinder.getString("Next"));
      ...
      clips.load("summerjobfinder.clp");
   ...
   private void nextUIState() throws Exception
     {
      ...
      if (fv.getFactSlot("state").toString().equals("final"))
        { 
         ...
         nextButton.setText(summerJobFinder.getString("Restart")); 
         prevButton.setVisible(true);
        }
      else if (fv.getFactSlot("state").toString().equals("initial"))
        {
         nextButton.setActionCommand("Next");
         nextButton.setText(summerJobFinder.getString("Next"));
      ...
      for (int i = 0; i < pv.size(); i++) 
        {
         ...
         if (bv.toString().equals(selected))
            { rButton = new JRadioButton(summerJobFinder.getString(bv.toString()),true); }
         else
            { rButton = new JRadioButton(summerJobFinder.getString(bv.toString()),false); }
      ...
      String theText = summerJobFinder.getString(fv.getFactSlot("display").symbolValue());
   ...
   public static void main(String args[])
     {  
      ...
      SwingUtilities.invokeLater(
        new Runnable() 
          {  
           public void run() { new SummerJobFinder(); }  
          });   
     }  
  }